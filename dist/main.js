"use strict";(()=>{var m=(a,c)=>()=>(a&&(c=a(a=0)),c);var k=(a,c)=>()=>(c||a((c={exports:{}}).exports,c),c.exports);var l,b=m(()=>{l={id:"acode.catppuccin",name:"Catppuccin",main:"dist/main.js",version:"1.0.0",readme:"readme.md",icon:"icon.png",files:[],minVersionCode:290,author:{name:"Raunak Raj",email:"bajrangcoders@gmail.com",github:"bajrangCoder"}}});var s,g=m(()=>{"use strict";s=`.ace-catppuccin-latte {
  color: #4c4f69;
...
}`});var C=k((A,n)=>{b();g();var r=acode.require("themes"),p=acode.require("themeBuilder"),u=acode.require("settings"),{editor:f}=editorManager,h=["latte","frappe","macchiato","mocha"],i="catppuccin";h.forEach(a=>{let c=`${i}-${a}`;ace.define(`ace/theme/${c}.css`,["require","exports","module"],function(e,o,t){t.exports=s}),ace.define(`ace/theme/${c}`,["require","exports","module",`ace/theme/${c}.css`,"ace/lib/dom"],function(e,o,t){o.isDark=a!=="latte",o.cssClass=`ace-${c}`,o.cssText=e(`./${c}.css`),e("../lib/dom").importCssString(o.cssText,o.cssClass,!1)}),function(){window.require([`ace/theme/${c}`],function(e){typeof n=="object"&&typeof A=="object"&&n&&(n.exports=e)})}()});var d=class{async init(){try{let c=document.createElement("style");c.textContent=`
